...
function EmergencyHeader() {
  return (
    <header className="flex overflow-hidden flex-col items-center px-10 pt-6 pb-28 font-bold text-white bg-green-400 max-md:px-5 max-md:pb-24 max-md:text-4xl">
      <section className="flex flex-col w-full">
        ...
        <img 
          ...
          className="object-contain mt-5 w-[80%] justify-center pt-5 flex pl-[20%]" 
        />
