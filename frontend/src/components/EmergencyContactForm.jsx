...
const EmergencyContactForm = () => {
    ...
    const validateForm = () => {
        ...
        // Check if phone number is empty and validate format
        if (!formData.phone) {
            newErrors.phone = 'Phone number is required';
        } else if (!/^\+91\d{10}$/.test(formData.phone)) {
            newErrors.phone = 'Phone number must in +91XXXXXXXXXX format';
        }
            ...
            {formVisible && (
                ...
                >
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="flex items-end justify-end cursor-pointer" onClick={resetForm}>
