...
const UserDashboard = () => {
    ...
    return (
        <div className="main">
            ...
            {/* Section 1 */}
            <section className="bg-[#71d699] mx-14 mt-10 shadow-xl shadow-[#4CAB72] rounded-2xl flex justify-center items-center">
            ...
            {/* Section 3 */}
            <section className="flex flex-col gap-10 justify-center items-center bg-[#0B5730] p-10 mt-10">
                ...
                <div className="flex items-center justify-center gap-10 flex-wrap">
                    {experts.map((img, key) => (
                        <img src={img} alt={`Expert ${key + 1}`} key={key} className="w-[200px] h-[200px] rounded-full" />
                    ))}
                </div>
            ...
            {/* Newsletter Section */}
            <section className="flex flex-col gap-7 justify-center items-center bg-[#0B5730] p-10 m-14 rounded-2xl">
