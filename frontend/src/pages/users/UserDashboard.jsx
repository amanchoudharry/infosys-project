    ...
    return (
        ...
        >
            ...
            <nav className="flex justify-between items-center px-24 sticky bg-[#b7fdd3] top-0 z-50">
                ...
                {/* {showProfile && (<div className='absolute top-20 bg-[#71d699] transition-all duration-300 rounded-xl px-10 shadow-xl shadow-green-600 p-3 right-24 flex flex-col gap-4 py-5'>
