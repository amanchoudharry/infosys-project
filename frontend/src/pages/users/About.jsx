    ...
    return (
        <div className='main'>
            ...
            <motion.section
                ...
                animate="visible"
            >
                <div className="m-10 pt-10 p-5 w-[60%] flex flex-col gap-10 py-20">
                    <motion.h1 className="text-4xl" variants={fadeInLeft}>
            ...
            >
                ...
                <div className='flex justify-between gap-5 items-center'>
                    {services.map((item, key) => (
                        <motion.div
                            key={key}
                            className={`${item.style} mt-10 bg-[#4CAB72] shadow-xl shadow-green-700 w-[60%] rounded-xl p-5 transition duration-500 transform hover:scale-105`}
                            variants={fadeIn}
                        >
                            <h1 className={`${item.text} text-2xl text-center font-bold text-white`}>{item.name}</h1>
