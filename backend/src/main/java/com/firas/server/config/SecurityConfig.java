    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/register", "/api/login","/api/users/search","/api/contacts","api/appointments","/api/contacts/{id}","/api/send-sos","/api/anxiety-test","/api/depression-test","/api/disorder-test","/api/services/{type}","/api/postpartum-test","/api/adhd-test","/api/bipolar-test").permitAll() // Public endpoints
